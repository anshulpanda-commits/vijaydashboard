...
export const CANONICAL_STORE_CODES = ["DJK","DRG","UIP","HMM","DRH","DHK","UGC","DLJ","UND"] as const;
...
export const HISTORICAL_MONTHS: HistoricalMonth[] = [
  {
    ...
    stores: [
      ...
      { storeName: "Faridabad",    storeCode: "HMM", totalUnits: 18, mtdRevenue: 165682, units: { Brisk: 4,  Halov2: 10, Stromgo: 3, Renpro: 0, Rengo: 0 } },
  ...
  },
  {
    ...
    stores: [
      ...
      { storeName: "Faridabad",    storeCode: "HMM", totalUnits: 21, mtdRevenue: 182579, units: { Brisk: 8,  Halov2: 9,  Stromgo: 4, Renpro: 0, Rengo: 0  } },
